...
- **API connection:**
  - **Endpoint:** `https://<your-store>.myshopify.com/api/2025-01/graphql.json` (Storefront API).
...
- [ ] **System pulse:** From project root run `.\scripts\health-checks.ps1` to verify lint, test, build, and (when reachable) Edge Function URLs.
...
| Doc | Purpose |
|-----|---------|
| **HEALTH-CHECK-PROTOCOL.md** | Build, lint, DB, and Edge Function checks. |
