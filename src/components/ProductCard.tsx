...
export const ProductCard = ({ product }: ProductCardProps) => {
  ...
  const nodeWithMetadata = node as typeof node & { tags?: string | string[]; createdAt?: string };
  const tags = nodeWithMetadata.tags || [];
  ...
  const createdAt = nodeWithMetadata.createdAt;
